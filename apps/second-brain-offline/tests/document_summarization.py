...
async def test_process_document_real_api():
    """Test with real API call for a single document"""
    ...
    document_data = {
        ...
        "child_urls": [
            ...
            "https://www.deeplearning.ai/community/",
            "https://www.deeplearning.ai/events/",
            "https://www.deeplearning.ai/ambassador/",
            "https://www.deeplearning.ai/blog/category/ambassador-spotlight/",
            "https://www.deeplearning.ai/resources/",
            "https://www.deeplearning.ai/about/",
            "https://www.deeplearning.ai/careers/",
            "https://www.deeplearning.ai/contact/",
            "https://www.deeplearning.ai/short-courses/quantization-in-depth/#overview",
            "https://www.deeplearning.ai/short-courses/quantization-in-depth/#course-outline",
            "https://www.deeplearning.ai/short-courses/quantization-in-depth/#instructors",
            "https://www.deeplearning.ai/courses/?courses_date_desc%5BrefinementList%5D%5Bcourse_type%5D%5B0%5D=Short%20Courses",
            ...
            "http://twitter.com/deeplearningai",
            "https://www.linkedin.com/company/18246783",
            "https://www.youtube.com/c/Deeplearningai"
        ]
    }
    
    test_doc = Document(**document_data)
    
    try:
        result = await agent._SummarizationAgent__summarize_document(
            document=test_doc,
            semaphore=None,  # Test without semaphore
            temperature=0.0
        )
        
        print(f"Result type: {type(result)}")
        print(f"Has summary: {hasattr(result, 'summary')}")
...
# Run the test
asyncio.run(test_process_document_real_api())